...
servers=(
  "system:mcp_servers/system_server.py:9105"
  "websearch:mcp_servers/websearch_server.py:9106"
  "winlog:mcp_servers/winlog_server.py:9108"
  "network:mcp_servers/network_server.py:9109"
  "docker:mcp_servers/docker_server.py:9111"
)
