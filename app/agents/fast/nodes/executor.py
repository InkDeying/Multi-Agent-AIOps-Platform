...
设计要点:
  - 默认走 app.harness.runtime.tool_runner.run_parallel_agent:
...
from app.harness.runtime.permissions import (
    PermissionDecision,
    PermissionMode,
    parse_permission_mode,
)
from app.harness.runtime.agent_harness import get_agent_harness
from app.harness.runtime.tool_filter import filter_tools_for_skill
