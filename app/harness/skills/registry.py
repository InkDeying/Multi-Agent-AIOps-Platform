...
设计:
  - 文件布局: app/harness/skills/definitions/<skill_name>/SKILL.md
...
from app.harness.skills.loader import SkillLoadError, load_skill_from_file
from app.harness.skills.models import Skill

# Skill 定义目录: app/harness/skills/definitions/<skill_name>/SKILL.md
    ...
    def get_or_generic(self, name: Optional[str]) -> Skill:
        ...
        if generic is None:
            raise RuntimeError(
                ...
                f"请确认 app/harness/skills/definitions/{GENERIC_SKILL_NAME}/SKILL.md 存在"
            )
        return generic
