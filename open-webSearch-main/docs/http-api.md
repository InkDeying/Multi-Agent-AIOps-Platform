...
```bash
curl --noproxy '*' http://127.0.0.1:3310/health
```
...
```bash
curl --noproxy '*' http://127.0.0.1:3310/status
```
...
```bash
curl --noproxy '*' -X POST http://127.0.0.1:3310/search \
...
```bash
curl --noproxy '*' -X POST http://127.0.0.1:3310/fetch-web \
  -H "Content-Type: application/json" \
...
```bash
curl --noproxy '*' -X POST http://127.0.0.1:3310/fetch-github-readme \
  -H "Content-Type: application/json" \
...
```bash
curl --noproxy '*' -X POST http://127.0.0.1:3310/fetch-csdn \
  -H "Content-Type: application/json" \
...
```bash
curl --noproxy '*' -X POST http://127.0.0.1:3310/fetch-juejin \
  -H "Content-Type: application/json" \
...
```bash
curl --noproxy '*' -X POST http://127.0.0.1:3310/fetch-linuxdo \
  -H "Content-Type: application/json" \
